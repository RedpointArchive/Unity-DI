...
public class UseArrowKeysMovementController : InjectedBehaviour, IMovementBehaviour
{
    private readonly IInputBehaviour _inputController;

    public UseArrowKeysMovementController(
        [FromParent] IInputBehaviour inputController)
    {
